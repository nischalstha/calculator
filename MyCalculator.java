...
public class MyCalculator extends JFrame implements ActionListener
{
    ...
    String[] buttonString = {"7", "8", "9", "+",
                             ...
                             "+/-", "=", "0",
                             "sin", "cos", "tan", "x^2",
                             "cosec", "sec", "cot", "log"}; //sin cos tan cosec sec cot x2 log
    ...
    MyCalculator() 
    {
        ...
        // Gave zero button dimension to the new buttons. 
        for(int i = 19; i < 27; i++)
    ...
    public void getSq()
    {
    	try 
    	{
            double value = (Double.parseDouble(display.getText())) * (Double.parseDouble(display.getText()));
            display.setText(Double.toString(value));
        } 
    	catch(NumberFormatException e) 
    	{
